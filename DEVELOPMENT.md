...
```bash
git remote add encore encore://affiliate-link-tracker-okc2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/affiliate-link-tracker-okc2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/affiliate-link-tracker-okc2/settings/integrations/github)
